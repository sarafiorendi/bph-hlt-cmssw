...
/*     edm::Wrapper<edm::RefVector<std::vector<reco::RecoChargedRefCandidateBase>,reco::RecoChargedRefCandidateBase,edm::refhelper::FindUsingAdvance<std::vector<reco::RecoChargedRefCandidateBase>,reco::RecoChargedRefCandidateBase> > > tpaaa3; */
    ...
    //sara: da cancellare in futuro
    reco::RecoChargedCandidateDoubleMap vrm4;
    edm::Wrapper<reco::RecoChargedCandidateDoubleMap> wrm4;
    edm::helpers::Key<edm::RefProd<reco::RecoChargedCandidateDoubleMap > > hrm4;

    reco::RecoChargedCandidateDoublePair vrp4;
    edm::Wrapper<reco::RecoChargedCandidateDoublePair> wrp4; 

    reco::TwoChargedCandidatePair vtccdp;
    edm::Wrapper<reco::TwoChargedCandidatePair> wtccdp; 

    reco::RecoChargedCandidatesDoublePair vrccp;
    edm::Wrapper<reco::RecoChargedCandidatesDoublePair> wrccp; 
    reco::RecoChargedCandidatesDoubleMap vrms3;
    edm::Wrapper<reco::RecoChargedCandidatesDoubleMap> wrms3;
    edm::helpers::Key<edm::RefProd<reco::RecoChargedCandidatesDoubleMap > > hrms3;


    reco::dfVector dfv3;
    edm::Wrapper<reco::dfVector> wdfv3; 
    reco::dfPair df3;
    edm::Wrapper<reco::dfPair> wdf3; 
